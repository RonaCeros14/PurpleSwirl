<?php
  ...
  if(isset($_POST['btnAddItem']))
  {
	...
	else
	{
		...
		$queryAddItem="INSERT INTO tbl_itemlist(itemName,itemDescription,measurement,quantity) VALUES('$varcharItemName','$varcharItemDescription','$varcharItemMeasurement','$doubleItemQuantity')";
		if(mysqli_query($connect, $queryAddItem))
		{
...
<head>
  ...
  <title>Purple Swirl | Add Item</title>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i> Items</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="itemStocks.php">Items</a></li>
              <li><i class="icon_document_alt"></i>Add Items</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
                ...
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="">
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" id="itemName" name="txtbxItemName" minlength="5" type="text" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="cemail" class="control-label col-lg-2">Description <span class="required"></span></label>
                      <div class="col-lg-10">
                        <input class="form-control " id="itemDescription" type="text" name="txtbxItemDescription" />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="curl" class="control-label col-lg-2">Measurement</label>
                      <div class="col-lg-10">
                        <input class="form-control " id="itemMeasurement" type="text" name="txtbxItemMeasurement" />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Quantity <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="itemQuanity" name="txtbxItemQuantity" minlength="0" type="number" required />
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">
                        <button class="btn btn-primary" type="submit" name="btnAddItem" >Save</button>
