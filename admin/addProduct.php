...
session_start();
  ...
  if(isset($_POST['btnAddProduct']))
  {
    ...
    else
    {
      ...
      $queryAddProduct ="INSERT INTO tbl_menu(productName,productDescription,unitPrice,productImage) VALUES('$varcharProductName','$varcharProductDescription','$doubleUnitPrice','$varcharProductImage')";
      if(mysqli_query($connect, $queryAddProduct))
      {
  ...
  <head>
    ...
    <title>Purple Swirl | Add Product</title>
                  ...
                  <div class="form">
                    <form class="form-validate form-horizontal" id="feedback_form" method="POST" enctype="multipart/form-data">
                      <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                          <input class="form-control" id="productName" name="txtbxProductName" minlength="5" type="text" required />
                        </div>
                      </div>
                      <div class="form-group ">
                        <label for="cemail" class="control-label col-lg-2">Description <span class="required"></span></label>
                        <div class="col-lg-10">
                          <input class="form-control " id="productDescription" type="text" name="txtbxProductDescription" />
                        </div>
                      </div>
                      <div class="form-group ">
                        <label for="curl" class="control-label col-lg-2">Unit Price <span class="required">*</span></label>
                        <div class="col-lg-10">
                          <input class="form-control " id="unitPrice" type="text" name="txtbxUnitPrice" />
                        </div>
                      </div>
                      <!--image upload -->
                      <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                          <input class="form-control" type="file" name="imgProductImage" accept="image/x-png,image/gif,image/jpeg,image/jpg" required />
                        </div>
                      </div>
                      <!--end of image upload-->
                      <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                          <button class="btn btn-primary" type="submit" name="btnAddProduct" >Save</button>
