                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <span class="profile-ava pull-right">
                      <img alt="" class="simple" src="img/avatar1_small.jpg">Rona de Juan
                    </span>
                  </div>
                </div>
              </div>
              <table class="table table-hover personal-task">
                <tbody>
                  <tr>
                    <td>24-10-18</td>
                    <td>
                      New York Cheesecake (Small)
                    </td>
                    <td>
                      <span class="badge bg-important">Processing</span>
                    </td>
                    <td>
                      2
                    </td>
                  ...
                  <tr>
                    <td>24-10-18</td>
                    <td>
                     Original Flavor (Large) with M&Ms Toppings
                    </td>
                    <td>
                      <span class="badge bg-success">Done</span>
                    </td>
