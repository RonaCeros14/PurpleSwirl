...
session_start();
  ...
  <head>
    ...
    <title>Purple Swirl | Items and Stock</title>
    ...
    <!--sidebar end-->
      ...
      <section id="main-content">
        <section class="wrapper">
          <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header"><i class="fa fa-table"></i> Items and Stock</h3>
              <a class="btn btn-primary" href="addItem.php" type="button">ADD ITEM</a>
            </div>
          </div>
          <br>
          <div class="row">
