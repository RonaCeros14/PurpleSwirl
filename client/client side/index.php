		...
		<div class="container">
			...
			<div class="agileinfo_new_products_grids">
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="images/originalflavor.jpg" alt=" " class="img-responsive" /> 
						</div>
						<h5><a href="single.html">Original Flavor Frozen Yogurt (Large)</a></h5>
						<div class="simpleCart_shelfItem">
							<p>P 110.00</p>
						</div>
					</div>
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<h5><a href="single.html">Watermelon Flavor Frozen Yogurt (Large)</a></h5>
						<div class="simpleCart_shelfItem">
							<p>P 130.00</p>
						</div>  
					</div>
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<h5><a href="single.html">Strawberry Flavor Frozen Yogurt (Medium)</a></h5>
						<div class="simpleCart_shelfItem">
							<p>P 120.00</p>
						</div>  
					</div>
