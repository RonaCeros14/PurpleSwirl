			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						...
						<li class="w3pages"><a href="productCategory.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Categories <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="#FrozenYogurt">Frozen Yogurt</a></li>
								<li><a href="#IceBlend">Ice Blended Drinks</a></li>     
							</ul>
						</li>  	
			...
			<div class="col-md-12 wthree_banner_bottom_left">
				<div class="video-img">
					...
					<div id="small-dialog" class="mfp-hide">
						<iframe src="images/psLogo.jpg"></iframe>
					</div>
					<script>
